...
@Getter
@Setter
@NoArgsConstructor(access = AccessLevel.PROTECTED) // 협업할 때 다른 개발자가 기본생성자로 객체를 생성하는 것을 방지 -> createOrder 메서드를 사용하도록 유도
public class Order {
...
//        }
//        for 문에 대고 option + enter -> Collapse loop with stream.sum() -> totalPrice에 대고 option + enter -> inline variable
